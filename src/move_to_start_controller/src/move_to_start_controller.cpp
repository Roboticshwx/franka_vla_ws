#include <move_to_start_controller/move_to_start_controller.hpp>
...
namespace move_to_start_controller {
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(move_to_start_controller::MoveToStartController, controller_interface::ControllerInterface)
